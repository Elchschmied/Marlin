...
#define CUSTOM_MACHINE_NAME "Ender-5 Plus Frank K."
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 38.74
  #define DEFAULT_bedKd 929.77
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 139.32 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  //#define FILAMENT_RUNOUT_DISTANCE_MM 25
    ...
    // Enable this option to use an encoder disc that toggles the pin
