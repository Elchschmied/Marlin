...
#define STRING_CONFIG_H_AUTHOR "(Klaus, Ulticlone)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Klaus-Ulticlone"
...
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
#define EXTRUDERS 1 //Dual Single

// Generally expected filament diameter (1.75, 2.85, 3.0, ...). Used for Volumetric, Filament Width Sensor, etc.
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75

// For Cyclops or any "multi-extruder" that shares a single nozzle.
//#define SINGLENOZZLE //Dual Single
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 203.57142857142858 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 20, 40 }
